...
// Query: *[_type == "product" && slug.current == $slug][0]{    title, description, images,    origin, material, density, style, pile, weave, sizes, care,    "category": category->{title, "slug": slug.current}  }
...
// Query: *[_type == "shop"] | order(order asc){name, address, phone, email, hours, mapsUrl, mapEmbed, image}
